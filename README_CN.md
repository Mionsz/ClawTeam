...
A standalone Chinese translation is no longer maintained.
...
For all current usage, command-line examples, supported agents (Claude Code,
Codex, OpenClaw, nanobot, Cursor, and any other CLI agent), feature list,
installation steps, and contribution guidelines, please refer to
[README.md](README.md).
